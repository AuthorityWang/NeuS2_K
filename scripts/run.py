...
def parse_args():
        ...
        parser.add_argument("--marching_cubes_res", default=500, type=int, help="Sets the resolution for the marching cubes grid.")
        ...
        parser.add_argument("--n_steps", type=int, default=1500, help="Number of steps to train for before quitting.")
